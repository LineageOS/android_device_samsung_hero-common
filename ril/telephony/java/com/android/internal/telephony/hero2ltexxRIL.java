 ...
 * {@hide}
 */
public class hero2ltexxRIL extends RIL implements CommandsInterface {
    ...
    public hero2ltexxRIL(Context context, int networkModes, int cdmaSubscription) {
        this(context, networkModes, cdmaSubscription, null);
        mAudioManager = (AudioManager)mContext.getSystemService(Context.AUDIO_SERVICE);
        mQANElements = 6;
    }

    public hero2ltexxRIL(Context context, int preferredNetworkType,
